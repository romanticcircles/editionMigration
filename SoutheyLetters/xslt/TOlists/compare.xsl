...
<xsl:stylesheet version="2.0"
    ...
    <!-- Load external corresp.xml document, but NB THIS only WORKS IF CHECKall.xml is in the XML main directory -->
    <xsl:variable name="corresp-doc" select="doc(resolve-uri('paratext/corresp.xml', base-uri(/)))"/>
