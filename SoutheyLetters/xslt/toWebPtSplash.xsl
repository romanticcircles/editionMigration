...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template match="tei:TEI">
        ...
        <html xml:lang="en" lang="en" id="{$docId}"
    ...
    <xsl:template match="tei:teiHeader">
        <xsl:variable name="ptNbr">
            <xsl:value-of
                select="normalize-space(substring-before(substring-after(tei:fileDesc/tei:editionStmt/tei:edition, 'Part'), tei:fileDesc/tei:editionStmt/tei:edition/tei:date))"
            />
        </xsl:variable>
        ...
        <head>
            ...
            <meta property="og:url"
                content="https://cha.artsci.tamu.edu/SoutheyLetters/HTML/Part_{$ptNbr}/index.html"/>
            ...
            <meta property="dc.identifier" content="https://cha.artsci.tamu.edu/SoutheyLetters/HTML/Part_{$ptNbr}/index.html" />
    ...
    <xsl:template match="tei:body">
        ...
        <xsl:variable name="getPtNbrName">
                ...
                <ul class="nav">
                    <li class="nav">
                        ...
                        <ul class="dropdown">
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '1'">
                                    <li><span class="here">One (1791-1797)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '2'">
                                    <li><span class="here">Two (1798-1803)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '3'">
                                    <li><span class="here">Three (1804-1809)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '4'">
                                    <li><span class="here">Four (1810-1815)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '5'">
                                    <li><span class="here">Five (1816-1818)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '6'">
                                    <li><span class="here">Six (1819-1821)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '7'">
                                    <li><span class="here">Seven (1822-1824)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '8'">
                                    <li><span class="here">Eight (1825-1827)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '9'">
                                    <li><span class="here">Nine (1828-1830)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '10'">
                                    <li><span class="here">Ten (1831-1833)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '11'">
                                    <li><span class="here">Eleven (1834-1836)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                            ...
                            <xsl:choose>
                                <xsl:when test="$getPartNbr = '12'">
                                    <li><span class="here">Twelve (1837-1839)</span></li>
                                </xsl:when>
                                <xsl:otherwise>
                                    <li>
                        ...
                        <li>
                            <a>
                                <xsl:attribute name="href">
                                    <xsl:value-of
                                        select="concat('southey.part', $getPtNbrName, 'Intro.html')"/>
                                </xsl:attribute>
